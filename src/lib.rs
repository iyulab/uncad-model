...
//! editor, a differ or a renderer reads it. The one operation it offers is
//! serialization -- [`CadDatabase::to_json`] and the `serde` derives on every
//! type -- and that serialization is the public contract (see [`json`]).
//!
